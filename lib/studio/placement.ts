...
export function toPlacement(envelope: unknown): Placement {
  ...
  return {
    ...
    maxConcurrentStreamsUncapped: num(e, "max_concurrent_streams_uncapped"),
    maxSlotsCeiling: num(e, "max_slots_ceiling"),
    ...
    slotCostBytes: num(e, "slot_cost_bytes"),
    weightsBytes: num(e, "weights_bytes"),
    overheadBytes: num(e, "overhead_bytes"),
    overheadBaseBytes: num(e, "overhead_base_bytes"),
    aggregateBytes: num(e, "aggregate_bytes"),
    usableVramBytes: num(e, "usable_vram_bytes"),
    kvDtypeBytes: num(e, "kv_dtype_bytes"),
    kvHeadroomBytes: num(e, "kv_headroom_bytes"),
