...
export default function ModelNotFound() {
  return (
    <div className="flex max-w-2xl flex-col gap-4">
      <h1 className="text-2xl leading-[1.2] font-semibold tracking-[-0.025em]">No such model</h1>
      ...
      <div className="border-border bg-surface flex flex-col gap-2 rounded-lg border p-4">
        ...
        <p className="text-muted text-sm">
          ...
          the slug is chosen when the model is registered. So the repo path a model was built from
          is usually a different string, and a different string is a 404.
        </p>
        <p className="text-muted text-sm">
          Case is <strong>not</strong> the problem — both this page and the gateway lowercase what
          they are given. The names are. Open the model from the catalog and copy the id off its
          page rather than retyping the repo path.
        </p>
      </div>
